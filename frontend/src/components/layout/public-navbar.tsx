...
/**
 * Public-facing navbar — shown on the homepage and all browsing pages
 * (product detail, category, supplier profile, search, requirements feed).
 * Guests see Login / Sign up buttons; authenticated users see their profile menu.
 */
          ...
          {isLoading && !user ? (
            ...
            <div className="relative">
              ...
              {menuOpen && (
                <div
                  role="menu"
                  className="absolute right-0 mt-2 w-56 overflow-hidden rounded-xl border border-ink-200 bg-white shadow-[var(--shadow-pop)] animate-fade-in"
                ...
                >
                  ...
                  <div className="py-1">
                    ...
                    <MenuLink href="/me/inquiries" onClick={() => setMenuOpen(false)} icon="💬">
                      My inquiries
                    </MenuLink>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="/register">
                <Button size="sm" className="shadow-sm">Sign up free</Button>
              </Link>
            </div>
          )}
        </nav>
